      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5">
        ...
        <div className="rounded-2xl border border-slate-800 bg-gradient-to-b from-slate-900 to-slate-950 p-4 shadow-lg">
          ...
          <div className="mt-2 flex items-center justify-between text-[11px] text-slate-400">
            ...
            <span className="text-slate-500">Day {kpi.currentDay} of {kpi.daysInMonth}</span>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-slate-800 bg-gradient-to-b from-slate-900 to-slate-950 p-4 shadow-lg">
          ...
          <div className="mt-2 text-2xl font-black tracking-tight text-white flex items-baseline gap-1.5">
          ...
          <div className="mt-2">
            <div className="flex items-center justify-between text-[10px] mb-1">
              <span className={kpi.isOverBudget ? "text-red-400 font-semibold" : "text-emerald-400 font-medium"}>
        ...
        <div className="rounded-2xl border border-slate-800 bg-gradient-to-b from-slate-900 to-slate-950 p-4 shadow-lg">
          ...
          <div className="mt-2 text-2xl font-black tracking-tight text-white flex items-center gap-1.5">
      ...
      <div className="rounded-2xl border border-slate-800 bg-slate-900/80 p-5 shadow-xl">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4">
          ...
          <div className="flex items-center gap-3 text-[11px]">
            ...
            <div className="flex items-center gap-1.5 text-slate-400">
              <div className="h-0.5 w-3 border-t border-dashed border-slate-500" />
        ...
        <div className="h-64 w-full">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={dailyBurn} margin={{ top: 10, right: 10, left: -15, bottom: 0 }}>
              <defs>
                <linearGradient id="colorTotal" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stop-color="#f59e0b" stop-opacity={0.3} />
                  <stop offset="95%" stop-color="#f59e0b" stop-opacity={0} />
                </linearGradient>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
                  ...
                  <PieChart>
                    ...
                    >
                      {categoryData.map((entry) => (
                        <Cell key={entry.id} fill={entry.color || "#3B82F6"} stroke="#0f172a" strokeWidth={2} />
                      ))}
                    </Pie>
                    <Tooltip
                      contentStyle={{
              ...
              <div className="flex-1 w-full space-y-2 max-h-52 overflow-y-auto pr-1">
                {categoryData.map((cat) => (
                  <div
                    key={cat.id}
                    className="flex items-center justify-between text-xs rounded-xl bg-slate-950/40 p-2 border border-slate-800/60"
                  >
          ...
          <div className="h-56 w-full mt-4">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={monthlyTrend} margin={{ top: 10, right: 10, left: -15, bottom: 0 }}>
                ...
                />
                {/* Normal is base bar, One-Time is stacked on top */}
